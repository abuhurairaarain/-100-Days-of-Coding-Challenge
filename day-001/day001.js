...
let myName = "Abu Hurera";
console.log(`Hello ${myName} would you like to learn some TypeScript today?`);
// Question 3: Name Cases: Store a person’s name in a variable, and then print that person’s name in lowercase, uppercase, and titlecase.
let fatherName = "Rafaqat Ali";
console.log(fatherName.toUpperCase());
console.log(fatherName.toLocaleLowerCase());
console.log(fatherName.charAt(0).toUpperCase() + fatherName.slice(1).toLocaleLowerCase());
